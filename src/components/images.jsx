...
export const TweeterImg = () => (
  <img src="/my-portfolio/tweeter.webp" alt="tweeter screenshot" />
);
...
export const EdieImg = () => (
  <img src="/my-portfolio/edie.webp" alt="edie homepage" />
);
export const PortfolioImg = () => (
  <img src="/my-portfolio/portfolio.webp" alt="edie homepage" />
);
export const WindBnBImg = () => (
  <img src="/my-portfolio/windbnb.webp" alt="WindBnB screenshot" />
);
export const InteriorImg = () => (
  <img src="/my-portfolio/interior-decor.webp" alt="interior screenshot" />
);
export const HuddleImg = () => (
  <img src="/my-portfolio/huddle.webp" alt="huddle screenshot" />
);
export const GalleryImg = () => (
  <img src="/my-portfolio/gallery.webp" alt="gallery screenshot" />
);
export const CheckoutImg = () => (
  <img src="/my-portfolio/checkout.webp" alt="checkout screenshot" />
);
export const SimplePlaylistImg = () => (
  <img
    src="/my-portfolio/simple-playlist.webp"
